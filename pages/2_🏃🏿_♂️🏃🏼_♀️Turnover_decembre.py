...
def generate_row(id):
    ...
    reason_weights = [0.05, 0.85, 0.1]  # Weights for Dismissal, Resignation, Conventional termination
    reason_for_departure = choices(["Dismissal", "Resignation", "Conventional termination"], weights=reason_weights, k=1)[0]
