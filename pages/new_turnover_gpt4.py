...
def generate_row_for_year(id, year):
    ...
    reason_for_departure = fake.random_element(elements=("Layoff", "Resignation", "Termination", "Retirement"), weights=(0.2, 0.3, 0.3, 0.2))
    ...
    return {
        ...
        "Gender": fake.random_element(elements=("Male", "Female"), weights=(0.6, 0.4)),
